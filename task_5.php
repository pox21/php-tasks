...
$users = [
    [
        ...
        "prof" => "UI/UX Expert",
        "role" => "Lead Author",
        "socialLink" => "https://twitter.com/@myplaneticket",
        "socialTag" => "@myplaneticket",
        "messageLink" => "https://wrapbootstrap.com/user/myorange",
    ],
    [
        ...
        "socialLink" => "https://twitter.com/@atlantez",
        "socialTag" => "@atlantez",
        "messageLink" => "https://wrapbootstrap.com/user/Walapa",
    ],
    [
        ...
        "prof" => "PHP Developer",
        "role" => "Partner &amp; Contributor",
        "socialLink" => "https://twitter.com/@lodev09",
        "socialTag" => "@lodev09",
        "messageLink" => "https://wrapbootstrap.com/user/lodev09",
    ],
    [
        ...
        "role" => "Partner &amp; Contributor",
        "socialLink" => "https://twitter.com/@sildur",
        "socialTag" => "@sildur",
        "messageLink" => "https://wrapbootstrap.com/user/sildur",
    ],
];
              ...
              <?php foreach ($users as $user) { ?>
                <div class="<?= $user["banned"] ? "banned" : '' ?> rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                  ...
                  <div class="ml-2 mr-3">
                    ...
                    <a href="<?= $user["socialLink"] ?>" class="text-info fs-sm"
                       target="_blank"><?= $user["socialTag"] ?></a> -
                    <a href="<?= $user["messageLink"] ?>" class="text-info fs-sm" target="_blank"
                       title="Contact <?= $user["name"] ?>"><i class="fal fa-envelope"></i></a>
                  </div>
                </div>
              <?php } ?>
          </div>
