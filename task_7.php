...
$users = dbQuery("select * from `users`")->fetchAll();
            ...
            <?php foreach ($users as $user) { ?>
              <div class="<?= $user["banned"] ? "banned" : '' ?> rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                ...
                <div class="ml-2 mr-3">
                  ...
                  <a href="<?= $user["social_link"] ?>" class="text-info fs-sm"
                     target="_blank"><?= $user["social_tag"] ?></a> -
                  <a href="<?= $user["message_link"] ?>" class="text-info fs-sm" target="_blank"
